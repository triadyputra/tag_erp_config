...
using tagApiKonfigurasi.Model.ENUM;

namespace tagApiKonfigurasi.Helper
{
    public static class HelperApp
    {
        ...
        public static async Task<string?> GetCabangAsync(
            this ClaimsPrincipal principal,
            UserManager<ApplicationUser> userManager,
            string? requestCabang = null
        )
        {
            ...
            var userCabang = user?.Cabang;

            // 🔥 PRIORITAS USER
            return !string.IsNullOrWhiteSpace(userCabang)
                ? userCabang
                : requestCabang;
        }
